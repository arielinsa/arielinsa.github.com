...
var style_Campos_y_Malezales_WDPA_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Irr_Glob");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 0.115450) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.115450 && value <= 0.304280) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.304280 && value <= 0.530170) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.530170 && value <= 0.747200) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.747200 && value <= 1.000000) {
            style = [ new ol.style.Style({
